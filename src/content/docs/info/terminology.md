...
### inferred molecules
Whereas _molecules_ refers to the source DNA molecule, _inferred molecules_ refer to the maximum extent of a molecule
that we can infer from the sequencing data. If the original DNA molecule was 1Mb and our data included two fragments
(see below) derived from it with the same barcode that were 75kb apart, we can only infer the molecule to have been
75kb.
